...
def generate_results(pytorch_model_path, coreml_model_path, adversarial_file_path, model_names):
    ...
    for i, model_name in enumerate(model_names):
        ...
        for idx in range(4):
            ...
            hidden = weight.new(no_layers, 300, hidden_dim).zero_().to(device)
            if idx != 3:
...
def main():
    ...
    pytorch_model_path = "/Volumes/Cisco/Fall2021/onnx-exchange/Training/pytorch/gru/"
    coreml_model_path = "/Volumes/Cisco/Fall2021/onnx-exchange/conversion/coremltools/pytorch/gru/"
    adversarial_file_path = "/Volumes/Cisco/Summer2022/onnx-exchange/adversarial/moses_NLP/pytorch-coreml/gru/data/"

    model_names = ["torch_state_GRU-IMDb_2021-11-01_1", "torch_state_GRU-IMDb_2021-11-01_2",
                   "torch_state_GRU-IMDb_2021-11-02_3", "torch_state_GRU-IMDb_2021-11-02_4",
                   "torch_state_GRU-IMDb_2021-11-02_5", "torch_state_GRU-IMDb_2021-11-02_6",
                   "torch_state_GRU-IMDb_2021-11-02_7", "torch_state_GRU-IMDb_2021-11-02_8",
                   "torch_state_GRU-IMDb_2021-11-02_9", "torch_state_GRU-IMDb_2021-11-03_10"]
